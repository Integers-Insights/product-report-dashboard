    ...
    return (
        <>
            <div className="border p-3 rounded-lg border-[#96DBFF] flex justify-between items-center bg-[#EDF9FF] mt-6">
                <p className="text-sm text-[#000000]">📧 3-step sequence · tuned for organic turmeric B2B buyers in USA + Germany · estimated 28–35% open rate</p>
                <button className="text-sm font-medium text-white bg-[#0284C7] rounded-lg cursor-pointer px-2 py-1">Copy All 3 Emails</button>
            </div>
                ...
                <div className="flex-1">
                    <div className="flex flex-col gap-6">
                        {emailData?.map((item, i) => {
                            return (
                                <div className="border p-4 rounded-lg border-[#D9D9D9] card-hover" key={i}>
                                    <p className="text-sm font-medium text-[#0284C7]">{item.txt1}</p>
                                    <p className="text-sm font-medium text-[#000000] mt-1">{item.txt2}</p>
                                    <div className="p-2 bg-gray-100 rounded-lg border-l-3 border-[#0284C7] mt-3 font-regular text-sm italic">
                                        {item.txt3}
                                    </div>
                                    <p className="text-sm text-[#5F6368] mt-3">{item.txt4}</p>
                                    ...
                                    <div className="mt-3 text-sm font-medium text-[#5F6368] flex gap-3">
                                        <span className="py-0.5 px-2 rounded-full bg-gray-100">{item.txt7}</span>
                                        <span className="py-0.5 px-2 rounded-full bg-gray-100">{item.txt8}</span>
                                        <span className="py-0.5 px-2 rounded-full bg-gray-100">{item.txt9}</span>
                                    </div>
                                </div>
                            )
                        })}
