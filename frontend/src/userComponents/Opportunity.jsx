        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 mt-6">
            ...
            <div className="rounded-lg border border-gray-300 bg-white p-6 shadow-xs card-hover">
                <div className="flex justify-between w-full">
                    ...
                    <div className='text-[#0284C7] text-xs'><a href="">View All</a></div>
                </div>
                {/* 1 */}
                <div className="border-b-1 border-[#E0F5FF] pb-1.5 flex justify-between items-center mt-3">
                    <div className="flex gap-3 items-center">
                        ...
                        <div>
                            ...
                            <p className="text-[#5F6368] text-xs">200+ buyers | Initiated 1m 32s ago</p>
                        </div>
                    </div>
                    <div className="flex gap-3 items-center">
                        <div className="flex relative w-20 h-8">
                            ...
                            <div className="flex justify-center items-center h-8 w-8 rounded-full absolute left-6"><img src={ellipse_5} alt="" /></div>
                            <div className="flex justify-center items-center h-8 w-8 rounded-full absolute left-9"><img src={ellipse_6} alt="" /></div>
                ...
                <div className="border-b-1 border-[#E0F5FF] pb-1.5 flex justify-between items-center mt-3">
                    <div className="flex gap-3 items-center">
                        ...
                        <div>
                            ...
                            <p className="text-[#5F6368] text-xs">Organic Turmeric Powder, USA | Initiated 1m 32s ago</p>
                        </div>
                    </div>
