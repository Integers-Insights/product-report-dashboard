...
import { ListBulletIcon, Squares2X2Icon, UserCircleIcon, DocumentMagnifyingGlassIcon, ClipboardDocumentListIcon, LightBulbIcon } from "@heroicons/react/24/outline";
import { useLayoutEffect, useRef, useState } from 'react'
import { people } from "./dummyTableData";
                                    ...
                                    <div className="group/table relative">
                                        <div className="relative min-w-full table-fixed divide-y divide-gray-300">
                                            <div className="divide-y divide-gray-200 bg-white rounded-xl border border-[#E6E6E6] mb-4">
                                                {view === "list" && <List people={people} selectedPeople={selectedPeople} setSelectedPeople={setSelectedPeople} />}
                                                {view === "grid" && <Grid people={people} selectedPeople={selectedPeople} setSelectedPeople={setSelectedPeople} />}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-2 mt-3">
                            <div className="flex items-center gap-1.5">
                                <span className="text-[28px] font-semibold text-[#000000]">3</span>
                                <span className="text-[#5F6368] text-13">queries</span>
                            </div>
                            <div className="text-right text-base font-medium text-[#000000] content-center">70</div>
                            <div className="text-[#5F6368] font-light text-xs">1 per product selected</div>
                            <div className="text-right text-[#5F6368] font-light text-xs">remaining after</div>
                        </div>
                        ...
                        <p className="flex justify-between">
                            <span className="text-[#5F6368] text-xs font-light">This run</span>
                            <span className="text-[#5F6368] text-xs font-light">Remaining</span>
                        </p>

                        <hr className="h-[1px] bg-[#E6E6E6] my-4 border-0" />
                        <p className="text-[#5F6368] font-light text-xs">WHAT HAPPENS NEXT</p>
                        ...
                        <div className="mt-3">
                            <div className="flex gap-3">
                                ...
                                <div>
                                    <p className='text-[#000000] text-sm font-medium'>Complete your profile</p>
                                    <p className='text-[#000000] text-xs font-light'>Business type, target regions, certifications</p>
                                </div>
                            </div>
                            <div className="flex gap-3 mt-4">
                                ...
                                <div>
                                    <p className='text-[#000000] text-sm font-medium'>Engine runs 6 modules</p>
                                    <p className='text-[#000000] text-xs font-light'>Demand · Keywords · Trade · Buyers · Price · Competition</p>
                                </div>
                            </div>
                            <div className="flex gap-3 mt-4">
                                ...
                                <div>
                                    <p className='text-[#000000] text-sm font-medium'>Full opportunity report</p>
                                    <p className='text-[#000000] text-xs font-light'>uyers, markets, keywords, email sequence</p>
                                </div>
                            </div>
                        </div>
