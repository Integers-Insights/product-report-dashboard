...
// const List = ({ people, selectedPeople, setSelectedPeople,products }) => {
...
// import { Link } from "react-router-dom";
// const List = ({ selectedProducts, setSelectedProducts, products,loading2 }) => {
...
//                               : selectedProducts.filter((p) => p !== prod),
//                           )
//                         }
//                       />
//                       <svg
...
//                   >
//                     View fetched data
//                     <span className="sr-only">, {prod?.product_name}</span>
//                   </Link>
//                 </div>
//               </div>
//             );
