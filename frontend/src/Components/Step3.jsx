...
//   console.log("selectedGoal", selectedGoal); // 1 payload
//   console.log("buyerType", buyerType); // 2 payload
//   console.log("priceType", priceType); // 3 payload
//   console.log("capacity", capacity); // 4 payload
...
//   console.log("selected: ", selected); // 4 payload
...
//                   className="block text-lg font-semibold text-[#001413] dark:text-white"
//                 >
...
//                                       type="checkbox"
//                                       value={ac1}
//                                       checked={certifications.quality_manufacturing.includes(
//                                         ac1,
//                                       )}
//                                       onChange={() =>
...
//                                       type="checkbox"
//                                       value={ac2}
//                                       checked={certifications.food_agriculture_organic.includes(
//                                         ac2,
//                                       )}
//                                       onChange={() =>
//                                         handleCheckboxChange(
...
//                                       type="checkbox"
//                                       value={ac3}
//                                       checked={certifications.pharma_health_safety.includes(
//                                         ac3,
//                                       )}
//                                       onChange={() =>
//                                         handleCheckboxChange(
...
//                                       type="checkbox"
//                                       value={ac4}
//                                       checked={certifications.religion_ethics_lifestyle.includes(
//                                         ac4,
//                                       )}
//                                       onChange={() =>
//                                         handleCheckboxChange(
...
//                                       type="checkbox"
//                                       value={ac5}
//                                       checked={certifications.technology_digital.includes(
//                                         ac5,
//                                       )}
//                                       onChange={() =>
//                                         handleCheckboxChange(
...
const Step3 = ({
  ...
  // console.log("selected: ", selected); // 5 payload
  ...
  //   // agar backend single string expect karta hai:
  //   // price_positioning: priceType.join(",")
