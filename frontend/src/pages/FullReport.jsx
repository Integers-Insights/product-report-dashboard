  ...
  const getFullReportData = async () => {
    try {
      ...
      if (allProductData.success) {
        ...
        setBanner_single_country(
          allProductData?.product?.headquarters_country || "",
        );
        ...
        setBanner_price_positioning(
          allProductData?.product?.price_positioning || "",
        );
        ...
        setMarketing_kit_data(
          allProductData?.marketing_intelligence?.marketing_info,
        );
      }
    } catch (err) {
