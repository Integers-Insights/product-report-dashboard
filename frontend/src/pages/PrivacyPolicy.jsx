          ...
          <div className="bg-white rounded-3xl border border-slate-200 shadow-card p-8 md:p-12">
            <Section title="1. WHO WE ARE">
              ...
              <p>
                ...
                protect it, and what rights you have over it. No legalese, no
                surprises.
              </p>
            </Section>
            ...
            <Section title="2. WHAT INFORMATION WE COLLECT">
              ...
              <ul className="list-disc ml-8">
                ...
                <li>
                  Business information you enter to personalise your reports
                </li>
              </ul>
              ...
              <p>
                We use this to keep the platform running smoothly and to spot
            ...
            <Section title="3. HOW WE USE YOUR INFORMATION">
              <p className="font-medium -mb-0.5">
                Here's the short version of why we need your data:
              </p>
              <ul className="list-disc ml-8">
                <li>To create and manage your account</li>
                <li>To generate the reports and intelligence you request</li>
                <li>To process your subscription payments</li>
                <li>
                  To send you service updates and, occasionally, useful content
            ...
            <Section title="6. YOUR RIGHTS">
              ...
              <ul className="list-disc ml-8">
                <li>See all the personal data we hold about you</li>
              ...
              <p>
                To do any of these, just email us at info@integersinsights.com.
            ...
            <Section title="7. COOKIES">
              <p>
                We use essential cookies to keep the platform working (you can't
                opt out of these without breaking the site) and optional
                analytics cookies to understand how people use REPORTINSHORT.
            ...
            <Section title="6. SECURITY">
              <p>
                ...
                encryption for data at rest. We run regular security reviews and
                follow industry-standard practices. If anything ever goes wrong,
            ...
            <Section title="6. CHANGES TO THIS POLICY">
              <p>
                If we make significant changes, we'll let you know by email
                before the changes take effect. Minor updates will be reflected
                in the "Last updated" date at the top.
              </p>
            </Section>
